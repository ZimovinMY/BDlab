...
Route::post('/ExportReportStats','MainController@ExportReportStats','ExportReportStats');
Route::get('/GetDownloadStats', 'MainController@GetDownloadStats')->name('GetDownloadStats');
